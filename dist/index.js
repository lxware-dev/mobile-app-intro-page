...
let as = class {
  ...
  get styleSheet() {
    ...
    if (ii && e === void 0) {
      ...
      i && (e = pi.get(t)), e === void 0 && ((this.o = e = new CSSStyleSheet()).replaceSync(this.cssText), i && pi.set(t, e));
    }
    return e;
  }
  toString() {
...
const os = (s) => new as(typeof s == "string" ? s : s + "", void 0, si), As = (s, ...e) => {
  ...
  if (ii) s.adoptedStyleSheets = e.map((t) => t instanceof CSSStyleSheet ? t : t.styleSheet);
  else for (const t of e) {
    const i = document.createElement("style"), r = et.litNonce;
    r !== void 0 && i.setAttribute("nonce", r), i.textContent = t.cssText, s.appendChild(i);
  }
}, fi = ii ? (s) => s : (s) => s instanceof CSSStyleSheet ? ((e) => {
  let t = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: zs, defineProperty: Ls, getOwnPropertyDescriptor: Is, getOwnPropertyNames: ks, getOwnPropertySymbols: _s, getPrototypeOf: Os } = Object, pe = globalThis, hi = pe.trustedTypes, Ds = hi ? hi.emptyScript : "", wt = pe.reactiveElementPolyfillSupport, He = (s, e) => s, st = { toAttribute(s, e) {
  switch (e) {
    case Boolean:
      s = s ? Ds : null;
      break;
  ...
  return t;
} }, ri = (s, e) => !zs(s, e), mi = { attribute: !0, type: String, converter: st, reflect: !1, hasChanged: ri };
...
class Pe extends HTMLElement {
  ...
  static getPropertyDescriptor(e, t, i) {
    const { get: r, set: n } = Is(this.prototype, e) ?? { get() {
      return this[t];
    }, set(o) {
      this[t] = o;
    } };
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(He("properties"))) {
      const t = this.properties, i = [...ks(t), ..._s(t)];
  ...
  static finalizeStyles(e) {
    ...
    if (Array.isArray(e)) {
      ...
      for (const r of i) t.unshift(fi(r));
    } else e !== void 0 && t.push(fi(e));
    return t;
  }
  static _$Eu(e, t) {
    const i = t.attribute;
  ...
  _$EC(e, t) {
    ...
    if (r !== void 0 && i.reflect === !0) {
      const o = (((n = i.converter) == null ? void 0 : n.toAttribute) !== void 0 ? i.converter : st).toAttribute(t, i.type);
  ...
  _$AK(e, t) {
    ...
    if (r !== void 0 && this._$Em !== r) {
      const o = i.getPropertyOptions(r), l = typeof o.converter == "function" ? { fromAttribute: o.converter } : ((n = o.converter) == null ? void 0 : n.fromAttribute) !== void 0 ? o.converter : st;
      this._$Em = r, this[r] = l.fromAttribute(t, o.type), this._$Em = null;
    }
  }
  requestUpdate(e, t, i) {
    if (e !== void 0) {
      if (i ?? (i = this.constructor.getPropertyOptions(e)), !(i.hasChanged ?? ri)(this[e], t)) return;
      this.P(e, t, i);
    }
...
Pe.elementStyles = [], Pe.shadowRootOptions = { mode: "open" }, Pe[He("elementProperties")] = /* @__PURE__ */ new Map(), Pe[He("finalized")] = /* @__PURE__ */ new Map(), wt == null || wt({ ReactiveElement: Pe }), (pe.reactiveElementVersions ?? (pe.reactiveElementVersions = [])).push("2.0.4");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const qe = globalThis, rt = qe.trustedTypes, gi = rt ? rt.createPolicy("lit-html", { createHTML: (s) => s }) : void 0, ls = "$lit$", ce = `lit$${Math.random().toFixed(9).slice(2)}$`, ds = "?" + ce, Bs = `<${ds}>`, we = document, Ve = () => we.createComment(""), Ye = (s) => s === null || typeof s != "object" && typeof s != "function", ni = Array.isArray, Rs = (s) => ni(s) || typeof (s == null ? void 0 : s[Symbol.iterator]) == "function", vt = `[ 	
\f\r]`, Oe = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, wi = /-->/g, vi = />/g, he = RegExp(`>|${vt}(?:([^\\s"'>=/]+)(${vt}*=${vt}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), bi = /'/g, yi = /"/g, cs = /^(?:script|style|textarea|title)$/i, Ns = (s) => (e, ...t) => ({ _$litType$: s, strings: e, values: t }), De = Ns(1), Ae = Symbol.for("lit-noChange"), j = Symbol.for("lit-nothing"), Si = /* @__PURE__ */ new WeakMap(), me = we.createTreeWalker(we, 129);
function us(s, e) {
...
const Hs = (s, e) => {
  ...
  let r, n = e === 2 ? "<svg>" : e === 3 ? "<math>" : "", o = Oe;
  for (let l = 0; l < t; l++) {
    const a = s[l];
    let p, d, f = -1, w = 0;
    for (; w < a.length && (o.lastIndex = w, d = o.exec(a), d !== null); ) w = o.lastIndex, o === Oe ? d[1] === "!--" ? o = wi : d[1] !== void 0 ? o = vi : d[2] !== void 0 ? (cs.test(d[2]) && (r = RegExp("</" + d[2], "g")), o = he) : d[3] !== void 0 && (o = he) : o === he ? d[0] === ">" ? (o = r ?? Oe, f = -1) : d[1] === void 0 ? f = -2 : (f = o.lastIndex - d[2].length, p = d[1], o = d[3] === void 0 ? he : d[3] === '"' ? yi : bi) : o === yi || o === bi ? o = he : o === wi || o === vi ? o = Oe : (o = he, r = void 0);
    const h = o === he && s[l + 1].startsWith("/>") ? " " : "";
    n += o === Oe ? a + Bs : f >= 0 ? (i.push(p), a.slice(0, f) + ls + a.slice(f) + ce + h) : a + ce + (f === -2 ? l : h);
  }
  return [us(s, n + (s[t] || "<?>") + (e === 2 ? "</svg>" : e === 3 ? "</math>" : "")), i];
};
class je {
  constructor({ strings: e, _$litType$: t }, i) {
    ...
    this.parts = [];
    let n = 0, o = 0;
    const l = e.length - 1, a = this.parts, [p, d] = Hs(e, t);
    if (this.el = je.createElement(p, i), me.currentNode = this.el.content, t === 2 || t === 3) {
      const f = this.el.content.firstChild;
      f.replaceWith(...f.childNodes);
    }
    for (; (r = me.nextNode()) !== null && a.length < l; ) {
      if (r.nodeType === 1) {
        if (r.hasAttributes()) for (const f of r.getAttributeNames()) if (f.endsWith(ls)) {
          const w = d[o++], h = r.getAttribute(f).split(ce), c = /([.?@])?(.*)/.exec(w);
          a.push({ type: 1, index: n, name: c[2], strings: h, ctor: c[1] === "." ? Gs : c[1] === "?" ? Fs : c[1] === "@" ? Vs : ot }), r.removeAttribute(f);
        } else f.startsWith(ce) && (a.push({ type: 6, index: n }), r.removeAttribute(f));
        if (cs.test(r.tagName)) {
          const f = r.textContent.split(ce), w = f.length - 1;
          if (w > 0) {
            r.textContent = rt ? rt.emptyScript : "";
            for (let h = 0; h < w; h++) r.append(f[h], Ve()), me.nextNode(), a.push({ type: 2, index: ++n });
            r.append(f[w], Ve());
          }
        }
      } else if (r.nodeType === 8) if (r.data === ds) a.push({ type: 2, index: n });
      else {
        let f = -1;
        for (; (f = r.data.indexOf(ce, f + 1)) !== -1; ) a.push({ type: 7, index: n }), f += ce.length - 1;
      }
      n++;
    }
  }
...
function $e(s, e, t = s, i) {
  ...
  return (r == null ? void 0 : r.constructor) !== n && ((l = r == null ? void 0 : r._$AO) == null || l.call(r, !1), n === void 0 ? r = void 0 : (r = new n(s), r._$AT(s, t, i)), i !== void 0 ? (t._$Co ?? (t._$Co = []))[i] = r : t._$Cl = r), r !== void 0 && (e = $e(s, r._$AS(s, e.values), r, i)), e;
}
class qs {
  constructor(e, t) {
  ...
  u(e) {
    const { el: { content: t }, parts: i } = this._$AD, r = ((e == null ? void 0 : e.creationScope) ?? we).importNode(t, !0);
    me.currentNode = r;
    let n = me.nextNode(), o = 0, l = 0, a = i[0];
    for (; a !== void 0; ) {
      if (o === a.index) {
        let p;
        a.type === 2 ? p = new Ue(n, n.nextSibling, this, e) : a.type === 1 ? p = new a.ctor(n, a.name, a.strings, this, e) : a.type === 6 && (p = new Ys(n, this, e)), this._$AV.push(p), a = i[++l];
      }
      o !== (a == null ? void 0 : a.index) && (n = me.nextNode(), o++);
    }
    return me.currentNode = we, r;
  }
  p(e) {
    let t = 0;
...
class Ue {
  ...
  constructor(e, t, i, r) {
    this.type = 2, this._$AH = j, this._$AN = void 0, this._$AA = e, this._$AB = t, this._$AM = i, this.options = r, this._$Cv = (r == null ? void 0 : r.isConnected) ?? !0;
  }
  get parentNode() {
  ...
  _$AI(e, t = this) {
    e = $e(this, e, t), Ye(e) ? e === j || e == null || e === "" ? (this._$AH !== j && this._$AR(), this._$AH = j) : e !== this._$AH && e !== Ae && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : Rs(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  _(e) {
    this._$AH !== j && Ye(this._$AH) ? this._$AA.nextSibling.data = e : this.T(we.createTextNode(e)), this._$AH = e;
  }
  $(e) {
    var n;
    const { values: t, _$litType$: i } = e, r = typeof i == "number" ? this._$AC(e) : (i.el === void 0 && (i.el = je.createElement(us(i.h, i.h[0]), this.options)), i);
    if (((n = this._$AH) == null ? void 0 : n._$AD) === r) this._$AH.p(t);
    else {
      const o = new qs(r, this), l = o.u(this.options);
      o.p(t), this.T(l), this._$AH = o;
    }
  }
  _$AC(e) {
    let t = Si.get(e.strings);
    return t === void 0 && Si.set(e.strings, t = new je(e)), t;
  }
  k(e) {
    ni(this._$AH) || (this._$AH = [], this._$AR());
    const t = this._$AH;
    let i, r = 0;
    for (const n of e) r === t.length ? t.push(i = new Ue(this.O(Ve()), this.O(Ve()), this, this.options)) : i = t[r], i._$AI(n), r++;
...
class ot {
  ...
  constructor(e, t, i, r, n) {
    this.type = 1, this._$AH = j, this._$AN = void 0, this.element = e, this.name = t, this._$AM = r, this.options = n, i.length > 2 || i[0] !== "" || i[1] !== "" ? (this._$AH = Array(i.length - 1).fill(new String()), this.strings = i) : this._$AH = j;
  }
  _$AI(e, t = this, i, r) {
    const n = this.strings;
    let o = !1;
    if (n === void 0) e = $e(this, e, t, 0), o = !Ye(e) || e !== this._$AH && e !== Ae, o && (this._$AH = e);
    else {
      const l = e;
      let a, p;
      for (e = n[0], a = 0; a < n.length - 1; a++) p = $e(this, l[i + a], t, a), p === Ae && (p = this._$AH[a]), o || (o = !Ye(p) || p !== this._$AH[a]), p === j ? e = j : e !== j && (e += (p ?? "") + n[a + 1]), this._$AH[a] = p;
    }
    o && !r && this.j(e);
  }
  j(e) {
...
class Vs extends ot {
  ...
  _$AI(e, t = this) {
    if ((e = $e(this, e, t, 0) ?? j) === Ae) return;
    const i = this._$AH, r = e === j && i !== j || e.capture !== i.capture || e.once !== i.once || e.passive !== i.passive, n = e !== j && (i === j || r);
...
const bt = qe.litHtmlPolyfillSupport;
bt == null || bt(je, Ue), (qe.litHtmlVersions ?? (qe.litHtmlVersions = [])).push("3.2.1");
const js = (s, e, t) => {
  const i = (t == null ? void 0 : t.renderBefore) ?? e;
  let r = i._$litPart$;
  if (r === void 0) {
    const n = (t == null ? void 0 : t.renderBefore) ?? null;
    i._$litPart$ = r = new Ue(e.insertBefore(Ve(), n), n, void 0, t ?? {});
  }
  return r._$AI(s), r;
};
/**
...
var ns;
Ge._$litElement$ = !0, Ge.finalized = !0, (ns = globalThis.litElementHydrateSupport) == null || ns.call(globalThis, { LitElement: Ge });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Xs = { attribute: !0, type: String, converter: st, reflect: !1, hasChanged: ri }, Us = (s = Xs, e, t) => {
...
function ps(s) {
  return (e, t) => typeof t == "object" ? Us(s, e, t) : ((i, r, n) => {
 ...
 */
function ai(s) {
  return ps({ ...s, state: !0, attribute: !1 });
}
function Ws(s) {
...
function ye() {
  ...
  return le.getSymbolSize = function(i) {
    ...
    return i * 4 + 17;
  }, le.getSymbolTotalCodewords = function(i) {
    return e[i];
  }, le.getBCHDigit = function(t) {
    let i = 0;
    for (; t !== 0; )
      i++, t >>>= 1;
    return i;
  }, le.setToSJISFunction = function(i) {
    if (typeof i != "function")
      throw new Error('"toSJISFunc" is not a valid function.');
    s = i;
  }, le.isKanjiModeEnabled = function() {
    return typeof s < "u";
  }, le.toSJIS = function(i) {
    return s(i);
  }, le;
}
var Et = {}, Ti;
...
function fs() {
  ...
  return Ze.getBlocksCount = function(r, n) {
    switch (n) {
      case s.L:
        return e[(r - 1) * 4 + 0];
      case s.M:
  ...
  }, Ze.getTotalCodewordsCount = function(r, n) {
    switch (n) {
      case s.L:
        return t[(r - 1) * 4 + 0];
      case s.M:
...
var Lt = {}, It = {}, kt = {}, _i;
function hs() {
  return _i || (_i = 1, kt.isValid = function(e) {
...
function nr() {
  return Bi || (Bi = 1, function(s) {
    const e = ye(), t = fs(), i = oi(), r = Se(), n = hs(), o = 7973, l = e.getBCHDigit(o);
    function a(w, h, c) {
      for (let u = 1; u <= 40; u++)
...
function ar() {
  if (Ri) return _t;
  Ri = 1;
  const s = ye(), e = 1335, t = 21522, i = s.getBCHDigit(e);
  return _t.getEncodedBits = function(n, o) {
    const l = n.bit << 3 | o;
    let a = l << 10;
...
var Vi;
function pr() {
  return Vi || (Vi = 1, function(s) {
    const e = Se(), t = or(), i = lr(), r = dr(), n = cr(), o = ms(), l = ye(), a = ur();
    function p(v) {
    ...
    function u(v, g) {
      ...
      for (let z = 0; z < v.length; z++) {
        ...
        for (let S = 0; S < A.length; S++) {
          const E = A[S], P = "" + z + S;
          C.push(P), m[P] = { node: E, lastCount: 0 }, y[P] = {};
          for (let T = 0; T < $.length; T++) {
            const x = $[T];
            m[x] && m[x].node.mode === E.mode ? (y[x][P] = w(m[x].lastCount + E.length, E.mode) - w(m[x].lastCount, E.mode), m[x].lastCount += E.length) : (m[x] && (m[x].lastCount = E.length), y[x][P] = w(E.length, E.mode) + 4 + e.getCharCountIndicator(E.mode, g));
          }
        }
        $ = C;
      }
 ...
 Suggested mode is: ` + e.toString(y));
    ...
    s.fromArray = function(g) {
      ...
      const y = f(g, l.isKanjiModeEnabled()), $ = c(y), z = u($, m), A = a.find_path(z.map, "start", "end"), C = [];
      for (let S = 1; S < A.length - 1; S++)
        C.push(z.table[A[S]].node);
...
function fr() {
  if (Yi) return xt;
  Yi = 1;
  const s = ye(), e = oi(), t = Qs(), i = Js(), r = Zs(), n = er(), o = tr(), l = fs(), a = rr(), p = nr(), d = ar(), f = Se(), w = pr();
  function h(z, A) {
    const C = z.size, S = n.getPositions(A);
    for (let E = 0; E < S.length; E++) {
      const P = S[E][0], T = S[E][1];
      for (let x = -1; x <= 7; x++)
        if (!(P + x <= -1 || C <= P + x))
          for (let M = -1; M <= 7; M++)
            T + M <= -1 || C <= T + M || (x >= 0 && x <= 6 && (M === 0 || M === 6) || M >= 0 && M <= 6 && (x === 0 || x === 6) || x >= 2 && x <= 4 && M >= 2 && M <= 4 ? z.set(P + x, T + M, !0, !0) : z.set(P + x, T + M, !1, !0));
    }
  }
  function c(z) {
    const A = z.size;
    for (let C = 8; C < A - 8; C++) {
      const S = C % 2 === 0;
      z.set(C, 6, S, !0), z.set(6, C, S, !0);
    }
  }
  function u(z, A) {
    const C = r.getPositions(A);
    for (let S = 0; S < C.length; S++) {
      const E = C[S][0], P = C[S][1];
      for (let T = -2; T <= 2; T++)
        for (let x = -2; x <= 2; x++)
          T === -2 || T === 2 || x === -2 || x === 2 || T === 0 && x === 0 ? z.set(E + T, P + x, !0, !0) : z.set(E + T, P + x, !1, !0);
    }
  }
  function b(z, A) {
    const C = z.size, S = p.getEncodedBits(A);
    let E, P, T;
    for (let x = 0; x < 18; x++)
      E = Math.floor(x / 3), P = x % 3 + C - 8 - 3, T = (S >> x & 1) === 1, z.set(E, P, T, !0), z.set(P, E, T, !0);
  }
  function v(z, A, C) {
    const S = z.size, E = d.getEncodedBits(A, C);
    let P, T;
    for (P = 0; P < 15; P++)
      T = (E >> P & 1) === 1, P < 6 ? z.set(P, 8, T, !0) : P < 8 ? z.set(P + 1, 8, T, !0) : z.set(S - 15 + P, 8, T, !0), P < 8 ? z.set(8, S - P - 1, T, !0) : P < 9 ? z.set(8, 15 - P - 1 + 1, T, !0) : z.set(8, 15 - P - 1, T, !0);
    z.set(S - 8, 8, 1, !0);
  }
  function g(z, A) {
    const C = z.size;
    let S = -1, E = C - 1, P = 7, T = 0;
    for (let x = C - 1; x > 0; x -= 2)
      for (x === 6 && x--; ; ) {
        for (let M = 0; M < 2; M++)
          if (!z.isReserved(E, x - M)) {
            let k = !1;
            T < A.length && (k = (A[T] >>> P & 1) === 1), z.set(E, x - M, k), P--, P === -1 && (T++, P = 7);
          }
        if (E += S, E < 0 || C <= E) {
          E -= S, S = -S;
          break;
  ...
  function m(z, A, C) {
    ...
    C.forEach(function(M) {
      S.put(M.mode.bit, 4), S.put(M.getLength(), f.getCharCountIndicator(M.mode, z)), M.write(S);
    });
    const E = s.getSymbolTotalCodewords(z), P = l.getTotalCodewordsCount(z, A), T = (E - P) * 8;
    for (S.getLengthInBits() + 4 <= T && S.put(0, 4); S.getLengthInBits() % 8 !== 0; )
      S.putBit(0);
    const x = (T - S.getLengthInBits()) / 8;
    for (let M = 0; M < x; M++)
      S.put(M % 2 ? 17 : 236, 8);
    return y(S, z, A);
  }
  function y(z, A, C) {
    const S = s.getSymbolTotalCodewords(A), E = l.getTotalCodewordsCount(A, C), P = S - E, T = l.getBlocksCount(A, C), x = S % T, M = T - x, k = Math.floor(S / T), R = Math.floor(P / T), L = R + 1, I = k - R, B = new a(I);
    let N = 0;
    const G = new Array(T), Y = new Array(T);
    let K = 0;
    const fe = new Uint8Array(z.buffer);
    for (let V = 0; V < T; V++) {
      const ee = V < M ? R : L;
      G[V] = fe.slice(N, N + ee), Y[V] = B.encode(G[V]), N += ee, K = Math.max(K, ee);
    }
  ...
  function $(z, A, C, S) {
    ...
    if (Array.isArray(z))
      ...
      let k = A;
      if (!k) {
        const R = w.rawSplit(z);
        k = p.getBestVersionForData(R, C);
      }
      E = w.fromString(z, k || 40);
    } else
      throw new Error("Invalid data");
    const P = p.getBestVersionForData(E, C);
    if (!P)
...
`
    ...
    const T = m(A, C, E), x = s.getSymbolSize(A), M = new i(x);
  ...
  return xt.create = function(A, C) {
    if (typeof A > "u" || A === "")
      throw new Error("No input text");
    let S = e.M, E, P;
    return typeof C < "u" && (S = e.from(C.errorCorrectionLevel, e.M), E = p.from(C.version), P = o.from(C.maskPattern), C.toSJISFunc && s.setToSJISFunction(C.toSJISFunc)), $(A, E, S, P);
  }, xt;
}
var qt = {}, Gt = {}, ji;
function gs() {
...
function mr() {
  ...
  return Ft.render = function(n, o, l) {
...
function gr() {
  ...
  return Ce.create = e.create, Ce.toCanvas = r.bind(null, t.render), Ce.toDataURL = r.bind(null, t.renderToDataURL), Ce.toString = r.bind(null, function(n, o, l) {
    return i.render(n, l);
  }), Ce;
}
var wr = gr();
const vr = /* @__PURE__ */ Ws(wr);
function Ki(s) {
...
function li(s, e) {
  ...
  Object.keys(e).filter((i) => t.indexOf(i) < 0).forEach((i) => {
    typeof s[i] > "u" ? s[i] = e[i] : Ki(e[i]) && Ki(s[i]) && Object.keys(e[i]).length > 0 && li(s[i], e[i]);
  });
}
const ws = {
  body: {},
  ...
  for (let t = 1; t < arguments.length; t += 1) {
    ...
    if (i != null && !xr(i)) {
      ...
      for (let n = 0, o = r.length; n < o; n += 1) {
        ...
        a !== void 0 && a.enumerable && (Re(s[l]) && Re(i[l]) ? i[l].__swiper__ ? s[l] = i[l] : J(s[l], i[l]) : !Re(s[l]) && Re(i[l]) ? (s[l] = {}, i[l].__swiper__ ? s[l] = i[l] : J(s[l], i[l])) : s[l] = i[l]);
      }
    }
  }
  return s;
...
function Tr(s, e) {
  const t = F();
  let i = e.contains(s);
  return !i && t.HTMLSlotElement && e instanceof HTMLSlotElement && (i = [...e.assignedElements()].includes(s), i || (i = Er(s, e))), i;
}
function nt(s) {
  try {
    console.warn(s);
...
function Z(s, e) {
  ...
  return t.classList.add(...Array.isArray(e) ? e : de(e)), t;
}
function at(s) {
...
function Ar(s) {
  ...
  const t = bs(), i = F(), r = i.navigator.platform, n = e || i.navigator.userAgent, o = {
    ios: !1,
    android: !1
...
function ys(s) {
  return s === void 0 && (s = {}), Yt || (Yt = Ar(s)), Yt;
}
let jt;
function $r() {
  const s = F(), e = ys();
...
function _r() {
  const s = this;
  function e(E, P) {
    return parseFloat(E.getPropertyValue(s.getDirectionLabel(P)) || 0);
  }
  const t = s.params, {
    wrapperEl: i,
    slidesEl: r,
  ...
  let m = t.spaceBetween, y = -u, $ = 0, z = 0;
  if (typeof n > "u")
    return;
  typeof m == "string" && m.indexOf("%") >= 0 ? m = parseFloat(m.replace("%", "")) / 100 * n : typeof m == "string" && (m = parseFloat(m)), s.virtualSize = -m, d.forEach((E) => {
  ...
  for (let E = 0; E < f; E += 1) {
    C = 0;
    let P;
    if (d[E] && (P = d[E]), A && s.grid.updateSlide(E, P, d), !(d[E] && ue(P, "display") === "none")) {
      if (t.slidesPerView === "auto") {
        S && (d[E].style[s.getDirectionLabel("width")] = "");
        const T = getComputedStyle(P), x = P.style.transform, M = P.style.webkitTransform;
        if (x && (P.style.transform = "none"), M && (P.style.webkitTransform = "none"), t.roundLengths)
          C = s.isHorizontal() ? Jt(P, "width") : Jt(P, "height");
        else {
          const k = e(T, "width"), R = e(T, "padding-left"), L = e(T, "padding-right"), I = e(T, "margin-left"), B = e(T, "margin-right"), N = T.getPropertyValue("box-sizing");
          if (N && N === "border-box")
            C = k + I + B;
          else {
            const {
        ...
        x && (P.style.transform = x), M && (P.style.webkitTransform = M), t.roundLengths && (C = Math.floor(C));
      } else
        C = (n - (t.slidesPerView - 1) * m) / t.slidesPerView, t.roundLengths && (C = Math.floor(C)), d[E] && (d[E].style[s.getDirectionLabel("width")] = `${C}px`);
      d[E] && (d[E].swiperSlideSize = C), c.push(C), t.centeredSlides ? (y = y + C / 2 + $ / 2 + m, $ === 0 && E !== 0 && (y = y - n / 2 - m), E === 0 && (y = y - n / 2 - m), Math.abs(y) < 1 / 1e3 && (y = 0), t.roundLengths && (y = Math.floor(y)), z % t.slidesPerGroup === 0 && w.push(y), h.push(y)) : (t.roundLengths && (y = Math.floor(y)), (z - Math.min(s.params.slidesPerGroupSkip, z)) % s.params.slidesPerGroup === 0 && w.push(y), h.push(y), y = y + C + m), s.virtualSize += C + m, $ = C, z += 1;
    }
  }
  if (s.virtualSize = Math.max(s.virtualSize, n) + b, o && l && (t.effect === "slide" || t.effect === "coverflow") && (i.style.width = `${s.virtualSize + m}px`), t.setWrapperSize && (i.style[s.getDirectionLabel("width")] = `${s.virtualSize + m}px`), A && s.grid.updateWrapperSize(C, w), !t.centeredSlides) {
    ...
    for (let P = 0; P < w.length; P += 1) {
      let T = w[P];
      t.roundLengths && (T = Math.floor(T)), w[P] <= s.virtualSize - n && E.push(T);
    }
    w = E, Math.floor(s.virtualSize - n) - Math.floor(w[w.length - 1]) > 1 && w.push(s.virtualSize - n);
  }
  if (a && t.loop) {
    const E = c[0] + m;
    if (t.slidesPerGroup > 1) {
      const P = Math.ceil((s.virtual.slidesBefore + s.virtual.slidesAfter) / t.slidesPerGroup), T = E * t.slidesPerGroup;
      for (let x = 0; x < P; x += 1)
        w.push(w[w.length - 1] + T);
    }
    for (let P = 0; P < s.virtual.slidesBefore + s.virtual.slidesAfter; P += 1)
      t.slidesPerGroup === 1 && w.push(w[w.length - 1] + E), h.push(h[h.length - 1] + E), s.virtualSize += E;
  }
  ...
  if (Object.assign(s, {
    ...
    Ne(i, "--swiper-centered-offset-before", `${-w[0]}px`), Ne(i, "--swiper-centered-offset-after", `${s.size / 2 - c[c.length - 1] / 2}px`);
    const E = -s.snapGrid[0], P = -s.slidesGrid[0];
    s.snapGrid = s.snapGrid.map((T) => T + E), s.slidesGrid = s.slidesGrid.map((T) => T + P);
  }
  if (f !== p && s.emit("slidesLengthChange"), w.length !== v && (s.params.watchOverflow && s.checkOverflow(), s.emit("snapGridLengthChange")), h.length !== g && s.emit("slidesGridLengthChange"), t.watchSlidesProgress && s.updateSlidesOffset(), s.emit("slidesUpdated"), !a && !t.cssMode && (t.effect === "slide" || t.effect === "fade")) {
    const E = `${t.containerModifierClass}backface-hidden`, P = s.el.classList.contains(E);
    f <= t.maxBackfaceHiddenSlides ? P || s.el.classList.add(E) : P && s.el.classList.remove(E);
  }
}
function Or(s) {
...
function Br(s) {
  ...
  for (let a = 0; a < i.length; a += 1) {
    ...
    b && (e.visibleSlides.push(p), e.visibleSlidesIndexes.push(a)), Qi(p, b, t.slideVisibleClass), Qi(p, u, t.slideFullyVisibleClass), p.progress = r ? -f : f, p.originalProgress = r ? -w : w;
  }
}
function Rr(s) {
  const e = this;
...
function Nr() {
  ...
  a && (o || (d = Cr(a, `.${t.slideClass}, swiper-slide`)[0], t.loop && !d && (d = e[0]), p = Mr(a, `.${t.slideClass}, swiper-slide`)[0], t.loop && !p === 0 && (p = e[e.length - 1]))), e.forEach((f) => {
    Xt(f, f === a, t.slideActiveClass), Xt(f, f === d, t.slideNextClass), Xt(f, f === p, t.slidePrevClass);
  }), s.emitSlidesClasses();
}
const tt = (s, e) => {
...
function qr(s) {
  ...
  if (typeof a > "u" && (a = Hr(e)), i.indexOf(t) >= 0)
    p = i.indexOf(t);
  else {
  ...
  Object.assign(e, {
    ...
    previousIndex: n,
    activeIndex: a
  }), e.initialized && Zt(e), e.emit("activeIndexChange"), e.emit("snapIndexChange"), (e.initialized || e.params.runCallbacksOnInit) && (o !== w && e.emit("realIndexChange"), e.emit("slideChange"));
}
function Gr(s, e) {
...
var Fr = {
  ...
  updateSlides: _r,
  updateAutoHeight: Or,
  updateSlidesOffset: Dr,
  updateSlidesProgress: Br,
  updateProgress: Rr,
  updateSlidesClasses: Nr,
  updateActiveIndex: qr,
  updateClickedSlide: Gr
};
function Vr(s) {
...
function Qr(s, e) {
  ...
  i.cssMode || (i.autoHeight && t.updateAutoHeight(), xs({
    swiper: t,
    runCallbacks: s,
    direction: e,
    step: "Start"
...
function Jr(s, e) {
  ...
  t.animating = !1, !i.cssMode && (t.setTransition(0), xs({
    swiper: t,
    runCallbacks: s,
    direction: e,
    step: "End"
...
function en(s, e, t, i, r) {
  ...
  if (l.normalizeSlideIndex)
    for (let A = 0; A < p.length; A += 1) {
      const C = -Math.floor(v * 100), S = Math.floor(p[A] * 100), E = Math.floor(p[A + 1] * 100);
      typeof p[A + 1] < "u" ? C >= S && C < E - (E - S) / 2 ? o = A : C >= S && C < E && (o = A + 1) : C >= S && (o = A);
    }
...
function on() {
  ...
  if (e.loop) {
    ...
    n = parseInt(s.clickedSlide.getAttribute("data-swiper-slide-index"), 10), e.centeredSlides ? r < s.loopedSlides - i / 2 || r > s.slides.length - s.loopedSlides + i / 2 ? (s.loopFix(), r = s.getSlideIndex(U(t, `${o}[data-swiper-slide-index="${n}"]`)[0]), ve(() => {
      s.slideTo(r);
    })) : s.slideTo(r) : r > s.slides.length - i ? (s.loopFix(), r = s.getSlideIndex(U(t, `${o}[data-swiper-slide-index="${n}"]`)[0]), ve(() => {
      s.slideTo(r);
    })) : s.slideTo(r);
  } else
    s.slideTo(r);
...
function cn(s) {
  ...
  p.length < u + v ? nt("Swiper Loop Warning: The number of slides is not enough for loop mode, it will be disabled and not function properly. You need to add more slides (or make duplicates) or lower the values of slidesPerView and slidesPerGroup parameters") : g && h.grid.fill === "row" && nt("Swiper Loop Warning: Loop mode is not compatible with grid.fill = `row`");
  const m = [], y = [];
  let $ = a.activeIndex;
  typeof n > "u" ? n = a.getSlideIndex(p.find((x) => x.classList.contains(h.slideActiveClass))) : $ = n;
  const z = i === "next" || !i, A = i === "prev" || !i;
  let C = 0, S = 0;
  const E = g ? Math.ceil(p.length / h.grid.rows) : p.length, T = (g ? p[n].column : n) + (c && typeof r > "u" ? -u / 2 + 0.5 : 0);
  if (T < v) {
    C = Math.max(v - T, b);
    for (let x = 0; x < v - T; x += 1) {
  ...
  if (a.__preventObserver__ = !0, requestAnimationFrame(() => {
    ...
    p[x].swiperLoopMoveDOM = !0, w.prepend(p[x]), p[x].swiperLoopMoveDOM = !1;
  }), z && y.forEach((x) => {
    p[x].swiperLoopMoveDOM = !0, w.append(p[x]), p[x].swiperLoopMoveDOM = !1;
  }), a.recalcSlides(), h.slidesPerView === "auto" ? a.updateSlides() : g && (m.length > 0 && A || y.length > 0 && z) && a.slides.forEach((x, M) => {
    a.grid.updateSlide(M, x, a.slides);
  }), h.watchSlidesProgress && a.updateSlidesOffset(), t) {
    if (m.length > 0 && A) {
      if (typeof e > "u") {
        const x = a.slidesGrid[$], k = a.slidesGrid[$ + C] - x;
      ...
      if (typeof e > "u") {
        ...
        const x = g ? y.length / h.grid.rows : y.length;
...
function wn(s) {
  ...
  if (i.type === "touchstart") {
    Ji(e, i, i.targetTouches[0].pageX);
    return;
  }
  const {
    params: n,
  ...
  let a = i.target;
  if (n.touchEventsTarget === "wrapper" && !Tr(a, e.wrapperEl) || "which" in i && i.which === 3 || "button" in i && i.button > 0 || r.isTouched && r.isMoved) return;
  ...
  if (n.noSwiping && (w ? gn(f, a) : a.closest(f))) {
    e.allowClick = !0;
    return;
  }
...
function bn(s) {
  ...
  for (let $ = 0; $ < p.length; $ += $ < o.slidesPerGroupSkip ? 1 : o.slidesPerGroup) {
    const z = $ < o.slidesPerGroupSkip - 1 ? 1 : o.slidesPerGroup;
    typeof p[$ + z] < "u" ? (c || h >= p[$] && h < p[$ + z]) && (u = $, b = p[$ + z] - p[$]) : (c || h >= p[$]) && (u = $, b = p[p.length - 1] - p[p.length - 2]);
  }
  let v = null, g = null;
...
function xn(s) {
  const e = this;
  tt(e, s.target), !(e.params.cssMode || e.params.slidesPerView !== "auto" && !e.params.autoHeight) && e.update();
}
function En() {
  const s = this;
...
const Es = (s, e) => {
  ...
  !r || typeof r == "string" || (t[a]("touchstart", s.onDocumentTouchStart, {
    ...
    passive: !0
  }), (i.preventClicks || i.preventClicksPropagation) && r[a]("click", s.onClick, !0), i.cssMode && n[a]("scroll", s.onScroll), i.updateOnWindowResize ? s[p](o.ios || o.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", Zi, !0) : s[p]("observerUpdate", Zi, !0), r[a]("load", s.onLoad, {
    capture: !0
  }));
};
function Tn() {
  ...
  s.onTouchStart = wn.bind(s), s.onTouchMove = vn.bind(s), s.onTouchEnd = bn.bind(s), s.onDocumentTouchStart = En.bind(s), e.cssMode && (s.onScroll = Sn.bind(s)), s.onClick = yn.bind(s), s.onLoad = xn.bind(s), Es(s, "on");
}
function Mn() {
  Es(this, "off");
}
...
const es = (s, e) => s.grid && e.grid && e.grid.rows > 1;
function Pn() {
  const s = this, {
    realIndex: e,
    initialized: t,
  ...
  const f = (p in n ? n[p] : void 0) || s.originalParams, w = es(s, i), h = es(s, f), c = s.params.grabCursor, u = f.grabCursor, b = i.enabled;
  w && !h ? (r.classList.remove(`${i.containerModifierClass}grid`, `${i.containerModifierClass}grid-column`), s.emitContainerClasses()) : !w && h && (r.classList.add(`${i.containerModifierClass}grid`), (f.grid.fill && f.grid.fill === "column" || !f.grid.fill && i.grid.fill === "column") && r.classList.add(`${i.containerModifierClass}grid-column`), s.emitContainerClasses()), c && !u ? s.unsetGrabCursor() : !c && u && s.setGrabCursor(), ["navigation", "pagination", "scrollbar"].forEach((z) => {
    if (typeof f[z] > "u") return;
    const A = i[z] && i[z].enabled, C = f[z] && f[z].enabled;
    A && !C && s[z].disable(), !A && C && s[z].enable();
  });
  const v = f.direction && f.direction !== i.direction, g = i.loop && (f.slidesPerView !== i.slidesPerView || v), m = i.loop;
  v && t && s.changeDirection(), J(s.params, f);
...
function Ln() {
  const s = this, {
    ...
    el: r,
    device: n
  } = s, o = zn(["initialized", t.direction, {
...
class Q {
  constructor() {
    ...
    for (var i = arguments.length, r = new Array(i), n = 0; n < i; n++)
      r[n] = arguments[n];
    r.length === 1 && r[0].constructor && Object.prototype.toString.call(r[0]).slice(8, -1) === "Object" ? t = r[0] : [e, t] = r, t || (t = {}), t = J({}, t), e && !t.el && (t.el = e);
    const o = X();
    ...
    const l = this;
    l.__swiper__ = !0, l.support = bs(), l.device = ys({
      userAgent: t.userAgent
    }), l.browser = Ss(), l.eventsListeners = {}, l.eventsAnyListeners = [], l.modules = [...l.__modules__], t.modules && Array.isArray(t.modules) && l.modules.push(...t.modules);
    const a = {};
    l.modules.forEach((d) => {
      d({
        params: t,
    ...
    const p = J({}, ei, a);
    return l.params = J({}, p, Kt, t), l.originalParams = J({}, l.params), l.passedParams = J({}, t), l.params && l.params.on && Object.keys(l.params.on).forEach((d) => {
  ...
  getSlideIndex(e) {
    const {
      slidesEl: t,
      params: i
    } = this, r = U(t, `.${i.slideClass}, swiper-slide`), n = Xe(r[0]);
    return Xe(e) - n;
  }
  ...
  mount(e) {
    ...
    return !o && t.params.createElements && (o = Z("div", t.params.wrapperClass), i.append(o), U(i, `.${t.params.slideClass}`).forEach((l) => {
      ...
      rtlTranslate: t.params.direction === "horizontal" && (i.dir.toLowerCase() === "rtl" || ue(i, "direction") === "rtl"),
  ...
  init(e) {
    ...
    return t.isElement && r.push(...t.hostEl.querySelectorAll('[loading="lazy"]')), r.forEach((n) => {
      n.complete ? tt(t, n) : n.addEventListener("load", (o) => {
        tt(t, o.target);
      });
    }), Zt(t), t.initialized = !0, Zt(t), t.emit("init"), t.emit("afterInit"), t;
  }
  destroy(e, t) {
    ...
    return typeof i.params > "u" || i.destroyed || (i.emit("beforeDestroy"), i.initialized = !1, i.detachEvents(), r.loop && i.loopDestroy(), t && (i.removeClasses(), n && typeof n != "string" && n.removeAttribute("style"), o && o.removeAttribute("style"), l && l.length && l.forEach((a) => {
      ...
      i.off(a);
    }), e !== !1 && (i.el && typeof i.el != "string" && (i.el.swiper = null), yr(i)), i.destroyed = !0), null;
  }
...
Object.keys(Wt).forEach((s) => {
  Object.keys(Wt[s]).forEach((e) => {
    Q.prototype[e] = Wt[s][e];
  });
});
Q.use([zr, Lr]);
function Bn(s) {
  ...
  function p(c, u, b) {
    ...
    let k, R;
    m ? (k = Math.floor(v / 2) + g + A, R = Math.floor(v / 2) + g + z) : (k = v + (g - 1) + A, R = (y ? v : g) + z);
    let L = x - R, I = x + k;
    y || (L = Math.max(L, 0), I = Math.min(I, E.length - 1));
    let B = (e.slidesGrid[L] || 0) - (e.slidesGrid[0] || 0);
    y && x >= R ? (L -= R, m || (B += e.slidesGrid[0])) : y && x < R && (L = -R, m && (B += e.slidesGrid[0])), Object.assign(e.virtual, {
      from: L,
      to: I,
      offset: B,
    ...
    const G = [], Y = [], K = (_) => {
      let D = _;
      return _ < 0 ? D = E.length + _ : D >= E.length && (D = D - E.length), D;
    };
    if (c)
    ...
    const fe = y ? -E.length : 0, O = y ? E.length * 2 : E.length;
    for (let _ = fe; _ < O; _ += 1)
      if (_ >= L && _ <= I) {
        const D = K(_);
        typeof S > "u" || c ? Y.push(D) : (_ > S && Y.push(D), _ < C && G.push(D));
      }
    if (Y.forEach((_) => {
      e.slidesEl.append(a(E[_], _));
    }), y)
      for (let _ = G.length - 1; _ >= 0; _ -= 1) {
        const D = G[_];
        e.slidesEl.prepend(a(E[D], D));
      }
    else
      G.sort((_, D) => D - _), G.forEach((_) => {
        e.slidesEl.prepend(a(E[_], _));
      });
  ...
  function f(c) {
    ...
    if (e.params.virtual.cache) {
      ...
      Object.keys(g).forEach((y) => {
        const $ = g[y], z = $.getAttribute("data-swiper-slide-index");
        z && $.setAttribute("data-swiper-slide-index", parseInt(z, 10) + v), m[parseInt(y, 10) + v] = $;
      }), e.virtual.cache = m;
    }
    p(!0), e.slideTo(b, 0);
  }
  ...
  i("beforeInit", () => {
    ...
    e.params.virtual.enabled && e.params.cssMode && Ne(e.wrapperEl, "--swiper-virtual-size", `${e.virtualSize}px`);
    ...
    if (!(w.shiftKey || w.altKey || w.ctrlKey || w.metaKey) && !(n.activeElement && n.activeElement.nodeName && (n.activeElement.nodeName.toLowerCase() === "input" || n.activeElement.nodeName.toLowerCase() === "textarea"))) {
      if (e.params.keyboard.onlyInViewport && (u || b || v || g || m || y)) {
        ...
        if (ge(e.el, `.${e.params.slideClass}, swiper-slide`).length > 0 && ge(e.el, `.${e.params.slideActiveClass}`).length === 0)
          return;
        const z = e.el, A = z.clientWidth, C = z.clientHeight, S = o.innerWidth, E = o.innerHeight, P = at(z);
        f && (P.left -= z.scrollLeft);
        const T = [[P.left, P.top], [P.left + A, P.top], [P.left, P.top + C], [P.left + A, P.top + C]];
        for (let x = 0; x < T.length; x += 1) {
          const M = T[x];
          if (M[0] >= 0 && M[0] <= S && M[1] >= 0 && M[1] <= E) {
...
function Nn(s) {
  ...
  function d(m) {
    let A = 0, C = 0, S = 0, E = 0;
    return "detail" in m && (C = m.detail), "wheelDelta" in m && (C = -m.wheelDelta / 120), "wheelDeltaY" in m && (C = -m.wheelDeltaY / 120), "wheelDeltaX" in m && (A = -m.wheelDeltaX / 120), "axis" in m && m.axis === m.HORIZONTAL_AXIS && (A = C, C = 0), S = A * 10, E = C * 10, "deltaY" in m && (E = m.deltaY), "deltaX" in m && (S = m.deltaX), m.shiftKey && !S && (S = E, E = 0), (S || E) && m.deltaMode && (m.deltaMode === 1 ? (S *= 40, E *= 40) : (S *= 800, E *= 800)), S && !A && (A = S < 1 ? -1 : 1), E && !C && (C = E < 1 ? -1 : 1), {
      spinX: A,
      spinY: C,
      pixelX: S,
      pixelY: E
  ...
  function u(m) {
    ...
    if (!e.mouseEntered && !C && !z.releaseOnEdges) return !0;
    y.originalEvent && (y = y.originalEvent);
    let S = 0;
    const E = e.rtlTranslate ? -1 : 1, P = d(y);
    if (z.forceToAxis)
      if (e.isHorizontal())
        if (Math.abs(P.pixelX) > Math.abs(P.pixelY)) S = -P.pixelX * E;
        else return !0;
      else if (Math.abs(P.pixelY) > Math.abs(P.pixelX)) S = -P.pixelY;
      else return !0;
    else
      S = Math.abs(P.pixelX) > Math.abs(P.pixelY) ? -P.pixelX * E : -P.pixelY;
    if (S === 0) return !0;
    z.invert && (S = -S);
    let T = e.getTranslate() + S * z.sensitivity;
    if (T >= e.minTranslate() && (T = e.minTranslate()), T <= e.maxTranslate() && (T = e.maxTranslate()), $ = e.params.loop ? !0 : !(T === e.minTranslate() || T === e.maxTranslate()), $ && e.params.nested && y.stopPropagation(), !e.params.freeMode || !e.params.freeMode.enabled) {
      ...
      if (p.push(x), M ? (x.direction !== M.direction || x.delta > M.delta || x.time > M.time + 150) && h(x) : h(x), c(x))
        return !0;
    } else {
      const x = {
        time: te(),
        delta: Math.abs(S),
        direction: Math.sign(S)
      }, M = a && x.time < a.time + 500 && x.delta <= a.delta && x.direction === a.direction;
      if (!M) {
        a = void 0;
        let k = e.getTranslate() + S * z.sensitivity;
        const R = e.isBeginning, L = e.isEnd;
        if (k >= e.minTranslate() && (k = e.minTranslate()), k <= e.maxTranslate() && (k = e.maxTranslate()), e.setTransition(0), e.setTranslate(k), e.updateProgress(), e.updateActiveIndex(), e.updateSlidesClasses(), (!R && e.isBeginning || !L && e.isEnd) && e.updateSlidesClasses(), e.params.loop && e.loopFix({
          ...
          if (p.push(x), I && (x.delta > I.delta || x.direction !== I.direction))
            p.splice(0);
          else if (p.length >= 15 && x.time - B.time < 500 && B.delta - x.delta >= 1 && x.delta <= 6) {
            const N = S > 0 ? 0.8 : 0.2;
            a = x, p.splice(0), o = ve(() => {
          ...
          o || (o = ve(() => {
            ...
            const N = 0.5;
            a = x, p.splice(0), e.slideToClosest(e.params.speed, !0, void 0, N);
          }, 500));
        }
        if (M || r("scroll", y), e.params.autoplay && e.params.autoplay.disableOnInteraction && e.autoplay.stop(), z.releaseOnEdges && (k === e.minTranslate() || k === e.maxTranslate()))
          return !0;
      }
    }
...
function Hn(s) {
  ...
  function d() {
    ...
    if (e.params.navigation = di(e, e.originalParams.navigation, e.params.navigation, {
...
function qn(s) {
  ...
  function f(g) {
    const m = g.target.closest(ne(e.params.pagination.bulletClass));
    if (!m)
      return;
    g.preventDefault();
    const y = Xe(m) * e.params.slidesPerGroup;
    if (e.params.loop) {
  ...
  function w() {
    ...
    if (e.params.loop ? (z = e.previousRealIndex || 0, $ = e.params.slidesPerGroup > 1 ? Math.floor(e.realIndex / e.params.slidesPerGroup) : e.realIndex) : typeof e.snapIndex < "u" ? ($ = e.snapIndex, z = e.previousSnapIndex) : (z = e.previousIndex || 0, $ = e.activeIndex || 0), m.type === "bullets" && e.pagination.bullets && e.pagination.bullets.length > 0) {
      const S = e.pagination.bullets;
      let E, P, T;
      if (m.dynamicBullets && (o = Jt(S[0], e.isHorizontal() ? "width" : "height"), y.forEach((x) => {
        x.style[e.isHorizontal() ? "width" : "height"] = `${o * (m.dynamicMainBullets + 4)}px`;
      }), m.dynamicMainBullets > 1 && z !== void 0 && (l += $ - (z || 0), l > m.dynamicMainBullets - 1 ? l = m.dynamicMainBullets - 1 : l < 0 && (l = 0)), E = Math.max($ - l, 0), P = E + (Math.min(S.length, m.dynamicMainBullets) - 1), T = (P + E) / 2), S.forEach((x) => {
        ...
        S.forEach((x) => {
          const M = Xe(x);
          M === $ ? x.classList.add(...m.bulletActiveClass.split(" ")) : e.isElement && x.setAttribute("part", "bullet"), m.dynamicBullets && (M >= E && M <= P && x.classList.add(...`${m.bulletActiveClass}-main`.split(" ")), M === E && p(x, "prev"), M === P && p(x, "next"));
        });
      else {
        const x = S[$];
        if (x && x.classList.add(...m.bulletActiveClass.split(" ")), e.isElement && S.forEach((M, k) => {
      ...
      if (m.dynamicBullets) {
        const x = Math.min(S.length, m.dynamicMainBullets + 4), M = (o * x - o) / 2 - T * o, k = g ? "right" : "left";
        S.forEach((R) => {
    ...
    y.forEach((S, E) => {
      if (m.type === "fraction" && (S.querySelectorAll(ne(m.currentClass)).forEach((P) => {
        P.textContent = m.formatFractionCurrent($ + 1);
      }), S.querySelectorAll(ne(m.totalClass)).forEach((P) => {
        ...
        const T = ($ + 1) / C;
        let x = 1, M = 1;
        P === "horizontal" ? x = T : M = T, S.querySelectorAll(ne(m.progressbarFillClass)).forEach((k) => {
          k.style.transform = `translate3d(0,0,0) scaleX(${x}) scaleY(${M})`, k.style.transitionDuration = `${e.params.speed}ms`;
        });
      }
      m.type === "custom" && m.renderCustom ? (S.innerHTML = m.renderCustom(e, $ + 1, C), E === 0 && r("paginationRender", S)) : (E === 0 && r("paginationRender", S), r("paginationUpdate", S)), e.params.watchOverflow && e.enabled && S.classList[e.isLocked ? "add" : "remove"](m.lockClass);
    });
  }
  function h() {
    ...
    let $ = "";
    if (g.type === "bullets") {
      let z = e.params.loop ? Math.ceil(m / e.params.slidesPerGroup) : e.snapGrid.length;
      e.params.freeMode && e.params.freeMode.enabled && z > m && (z = m);
      for (let A = 0; A < z; A += 1)
    ...
    g.type === "fraction" && (g.renderFraction ? $ = g.renderFraction.call(e, g.currentClass, g.totalClass) : $ = `<span class="${g.currentClass}"></span> / <span class="${g.totalClass}"></span>`), g.type === "progressbar" && (g.renderProgressbar ? $ = g.renderProgressbar.call(e, g.progressbarFillClass) : $ = `<span class="${g.progressbarFillClass}"></span>`), e.pagination.bullets = [], y.forEach((z) => {
      g.type !== "custom" && (z.innerHTML = $ || ""), g.type === "bullets" && e.pagination.bullets.push(...z.querySelectorAll(ne(g.bulletClass)));
    }), g.type !== "custom" && r("paginationRender", y[0]);
  }
  function c() {
    e.params.pagination = di(e, e.originalParams.pagination, e.params.pagination, {
      el: "swiper-pagination"
    });
    const g = e.params.pagination;
    if (!g.el) return;
    let m;
    typeof g.el == "string" && e.isElement && (m = e.el.querySelector(g.el)), !m && typeof g.el == "string" && (m = [...document.querySelectorAll(g.el)]), m || (m = g.el), !(!m || m.length === 0) && (e.params.uniqueNavElements && typeof g.el == "string" && Array.isArray(m) && m.length > 1 && (m = [...e.el.querySelectorAll(g.el)], m.length > 1 && (m = m.find((y) => ge(y, ".swiper")[0] === e.el))), Array.isArray(m) && m.length === 1 && (m = m[0]), Object.assign(e.pagination, {
      el: m
    }), m = q(m), m.forEach((y) => {
  ...
  i("changeDirection", () => {
    ...
    if (e.params.pagination.el && e.params.pagination.hideOnClick && $ && $.length > 0 && !y.classList.contains(e.params.pagination.bulletClass)) {
      ...
      const z = $[0].classList.contains(e.params.pagination.hiddenClass);
      r(z === !0 ? "paginationShow" : "paginationHide"), $.forEach((A) => A.classList.toggle(e.params.pagination.hiddenClass));
    }
  });
  const b = () => {
...
function Gn(s) {
  ...
  function h() {
    ...
    const {
      ...
      dragEl: M,
      el: k
    } = T, R = e.params.scrollbar, L = e.params.loop ? e.progressLoop : e.progress;
    let I = d, B = (f - d) * L;
    x ? (B = -B, B > 0 ? (I = d - B, B = 0) : -B + d > f && (I = f + B)) : B < 0 ? (I = d + B, B = 0) : B + d > f && (I = f - B), e.isHorizontal() ? (M.style.transform = `translate3d(${B}px, 0, 0)`, M.style.width = `${I}px`) : (M.style.transform = `translate3d(0px, ${B}px, 0)`, M.style.height = `${I}px`), R.hide && (clearTimeout(l), k.style.opacity = 1, l = setTimeout(() => {
  ...
  function u() {
    ...
    x.style.width = "", x.style.height = "", f = e.isHorizontal() ? M.offsetWidth : M.offsetHeight, w = e.size / (e.virtualSize + e.params.slidesOffsetBefore - (e.params.centeredSlides ? e.snapGrid[0] : 0)), e.params.scrollbar.dragSize === "auto" ? d = f * w : d = parseInt(e.params.scrollbar.dragSize, 10), e.isHorizontal() ? x.style.width = `${d}px` : x.style.height = `${d}px`, w >= 1 ? M.style.display = "none" : M.style.display = "", e.params.scrollbar.hide && (M.style.opacity = 0), e.params.watchOverflow && e.enabled && T.el.classList[e.isLocked ? "add" : "remove"](e.params.scrollbar.lockClass);
  }
  function b(T) {
  ...
  function v(T) {
    ...
    let R;
    R = (b(T) - at(k)[e.isHorizontal() ? "left" : "top"] - (p !== null ? p : d / 2)) / (f - d), R = Math.max(Math.min(R, 1), 0), M && (R = 1 - R);
  ...
  function g(T) {
    ...
    o = !0, p = T.target === L ? b(T) - T.target.getBoundingClientRect()[e.isHorizontal() ? "left" : "top"] : null, T.preventDefault(), T.stopPropagation(), k.style.transitionDuration = "100ms", L.style.transitionDuration = "100ms", v(T), clearTimeout(a), R.style.transitionDuration = "0ms", x.hide && (R.style.opacity = 1), e.params.cssMode && (e.wrapperEl.style["scroll-snap-type"] = "none"), r("scrollbarDragStart", T);
  }
  function m(T) {
    const {
      scrollbar: x,
  ...
  function y(T) {
    ...
    o && (o = !1, e.params.cssMode && (e.wrapperEl.style["scroll-snap-type"] = "", k.style.transitionDuration = ""), x.hide && (clearTimeout(a), a = ve(() => {
      R.style.opacity = 0, R.style.transitionDuration = "400ms";
    }, 1e3)), r("scrollbarDragEnd", T), x.snapOnRelease && e.slideToClosest());
  }
  function $(T) {
    const {
      scrollbar: x,
    ...
    if (!k) return;
    const R = k, L = M.passiveListeners ? {
      passive: !1,
      capture: !1
    ...
    R[B]("pointerdown", g, L), n[B]("pointermove", m, L), n[B]("pointerup", y, I);
  }
  function z() {
  ...
  function C() {
    ...
    e.params.scrollbar = di(e, e.originalParams.scrollbar, e.params.scrollbar, {
      el: "swiper-scrollbar"
    });
    ...
    e.params.uniqueNavElements && typeof M.el == "string" && k.length > 1 && x.querySelectorAll(M.el).length === 1 && (k = x.querySelector(M.el)), k.length > 0 && (k = k[0]), k.classList.add(e.isHorizontal() ? M.horizontalClass : M.verticalClass);
    let R;
    k && (R = k.querySelector(ne(e.params.scrollbar.dragClass)), R || (R = Z("div", e.params.scrollbar.dragClass), k.append(R))), Object.assign(T, {
      el: k,
      dragEl: R
    }), M.draggable && z(), k && k.classList[e.enabled ? "remove" : "add"](...de(e.params.scrollbar.lockClass));
  }
  function S() {
    const T = e.params.scrollbar, x = e.scrollbar.el;
    x && x.classList.remove(...de(e.isHorizontal() ? T.horizontalClass : T.verticalClass)), A();
  }
  i("changeDirection", () => {
    ...
    T && T.classList[e.enabled ? "remove" : "add"](...de(e.params.scrollbar.lockClass));
  }), i("destroy", () => {
    S();
  });
  const E = () => {
    e.el.classList.remove(...de(e.params.scrollbar.scrollbarDisabledClass)), e.scrollbar.el && e.scrollbar.el.classList.remove(...de(e.params.scrollbar.scrollbarDisabledClass)), C(), u(), h();
  }, P = () => {
    e.el.classList.add(...de(e.params.scrollbar.scrollbarDisabledClass)), e.scrollbar.el && e.scrollbar.el.classList.add(...de(e.params.scrollbar.scrollbarDisabledClass)), S();
  };
...
function Vn(s) {
  ...
  function C(O) {
    if (O.pointerType === "mouse" && h.splice(0, h.length), !z(O)) return;
    ...
    if (f = !1, w = !1, h.push(O), !(h.length < 2)) {
      if (f = !0, c.scaleStart = g(), !c.slideEl) {
        ...
        if (D && (D = D.querySelectorAll("picture, img, svg, canvas, .swiper-zoom-target")[0]), c.imageEl = D, D ? c.imageWrapEl = ge(c.imageEl, `.${_.containerClass}`)[0] : c.imageWrapEl = void 0, !c.imageWrapEl) {
          c.imageEl = void 0;
          return;
        }
        c.maxRatio = m();
  ...
  function E(O) {
    if (!z(O) || O.pointerType === "mouse" && O.type === "pointerout") return;
    const _ = e.params.zoom, D = e.zoom, H = h.findIndex((V) => V.pointerId === O.pointerId);
  ...
  function k(O) {
    ...
    u.isMoved || (u.width = c.imageEl.offsetWidth || c.imageEl.clientWidth, u.height = c.imageEl.offsetHeight || c.imageEl.clientHeight, u.startX = Qt(c.imageWrapEl, "x") || 0, u.startY = Qt(c.imageWrapEl, "y") || 0, c.slideWidth = c.slideEl.offsetWidth, c.slideHeight = c.slideEl.offsetHeight, c.imageWrapEl.style.transitionDuration = "0ms");
  ...
  function R() {
    ...
    u.isTouched = !1, u.isMoved = !1;
    let _ = 300, D = 300;
    const H = b.x * _, V = u.currentX + H, ee = b.y * D, ae = u.currentY + ee;
    b.x !== 0 && (_ = Math.abs((V - u.currentX) / b.x)), b.y !== 0 && (D = Math.abs((ae - u.currentY) / b.y));
    const re = Math.max(_, D);
    u.currentX = V, u.currentY = ae;
    const oe = u.width * O.scale, W = u.height * O.scale;
    u.minX = Math.min(c.slideWidth / 2 - oe / 2, 0), u.maxX = -u.minX, u.minY = Math.min(c.slideHeight / 2 - W / 2, 0), u.maxY = -u.minY, u.currentX = Math.max(Math.min(u.currentX, u.maxX), u.minX), u.currentY = Math.max(Math.min(u.currentY, u.maxY), u.minY), c.imageWrapEl.style.transitionDuration = `${re}ms`, c.imageWrapEl.style.transform = `translate3d(${u.currentX}px, ${u.currentY}px,0)`;
  }
  function L() {
    const O = e.zoom;
  ...
  function I(O) {
    if (o <= 1 || !c.imageWrapEl || !z(O) || !A(O)) return;
    ...
    const H = (O.clientX - p.x) * d, V = (O.clientY - p.y) * d, ee = u.width * o, ae = u.height * o, re = c.slideWidth, oe = c.slideHeight, W = Math.min(re / 2 - ee / 2, 0), ie = -W, ke = Math.min(oe / 2 - ae / 2, 0), Ke = -ke, Ee = Math.max(Math.min(u.startX + H, ie), W), Te = Math.max(Math.min(u.startY + V, Ke), ke);
    c.imageWrapEl.style.transitionDuration = "0ms", c.imageWrapEl.style.transform = `translate3d(${Ee}px, ${Te}px, 0)`, p.x = O.clientX, p.y = O.clientY, u.startX = Ee, u.startY = Te, u.currentX = Ee, u.currentY = Te;
  }
  function B(O) {
    ...
    if (!c.slideEl) {
      ...
      let _e = c.slideEl.querySelector(`.${D.containerClass}`);
      _e && (_e = _e.querySelectorAll("picture, img, svg, canvas, .swiper-zoom-target")[0]), c.imageEl = _e, _e ? c.imageWrapEl = ge(c.imageEl, `.${D.containerClass}`)[0] : c.imageWrapEl = void 0;
    }
    ...
    let H, V, ee, ae, re, oe, W, ie, ke, Ke, Ee, Te, Qe, Je, pt, ft, ht, mt;
    typeof u.touchesStart.x > "u" && O ? (H = O.pageX, V = O.pageY) : (H = u.touchesStart.x, V = u.touchesStart.y);
    const gt = o, Me = typeof O == "number" ? O : null;
    o === 1 && Me && (H = void 0, V = void 0, u.touchesStart.x = void 0, u.touchesStart.y = void 0);
    const ui = m();
    _.scale = Me || ui, o = Me || ui, O && !(o === 1 && Me) ? (ht = c.slideEl.offsetWidth, mt = c.slideEl.offsetHeight, ee = at(c.slideEl).left + n.scrollX, ae = at(c.slideEl).top + n.scrollY, re = ee + ht / 2 - H, oe = ae + mt / 2 - V, ke = c.imageEl.offsetWidth || c.imageEl.clientWidth, Ke = c.imageEl.offsetHeight || c.imageEl.clientHeight, Ee = ke * _.scale, Te = Ke * _.scale, Qe = Math.min(ht / 2 - Ee / 2, 0), Je = Math.min(mt / 2 - Te / 2, 0), pt = -Qe, ft = -Je, gt > 0 && Me && typeof u.currentX == "number" && typeof u.currentY == "number" ? (W = u.currentX * _.scale / gt, ie = u.currentY * _.scale / gt) : (W = re * _.scale, ie = oe * _.scale), W < Qe && (W = Qe), W > pt && (W = pt), ie < Je && (ie = Je), ie > ft && (ie = ft)) : (W = 0, ie = 0), Me && _.scale === 1 && (c.originX = 0, c.originY = 0), u.currentX = W, u.currentY = ie, c.imageWrapEl.style.transitionDuration = "300ms", c.imageWrapEl.style.transform = `translate3d(${W}px, ${ie}px,0)`, c.imageEl.style.transitionDuration = "300ms", c.imageEl.style.transform = `translate3d(0,0,0) scale(${_.scale})`;
  }
  function N() {
    ...
    if (!c.slideEl) {
      ...
      let D = c.slideEl.querySelector(`.${_.containerClass}`);
      D && (D = D.querySelectorAll("picture, img, svg, canvas, .swiper-zoom-target")[0]), c.imageEl = D, D ? c.imageWrapEl = ge(c.imageEl, `.${_.containerClass}`)[0] : c.imageWrapEl = void 0;
    }
  ...
  function K() {
    ...
    e.wrapperEl.addEventListener("pointerdown", C, _), e.wrapperEl.addEventListener("pointermove", S, D), ["pointerup", "pointercancel", "pointerout"].forEach((H) => {
      e.wrapperEl.addEventListener(H, E, _);
  ...
  function fe() {
    ...
    e.wrapperEl.removeEventListener("pointerdown", C, _), e.wrapperEl.removeEventListener("pointermove", S, D), ["pointerup", "pointercancel", "pointerout"].forEach((H) => {
      e.wrapperEl.removeEventListener(H, E, _);
...
function Yn(s) {
  ...
  function l(p, d) {
    ...
    let h;
    function c(u) {
      u.destroyed || (u.setTransition(p, e), p !== 0 && (u.transitionStart(), u.params.autoHeight && ve(() => {
        u.updateAutoHeight();
      }), Fe(u.wrapperEl, () => {
        w && u.transitionEnd();
      })));
...
function jn(s) {
  ...
  function a(L) {
    const I = r;
    I.length !== 0 && (I.innerHTML = "", I.innerHTML = L);
  }
  function p(L) {
    const I = () => Math.round(16 * Math.random()).toString(16);
    return "x".repeat(L).replace(/x/g, I);
  }
  function d(L) {
    L = q(L), L.forEach((I) => {
  ...
  function y(L) {
    ...
    const I = e.params.a11y, B = L.target;
    if (!(e.pagination && e.pagination.el && (B === e.pagination.el || e.pagination.el.contains(L.target)) && !L.target.matches(ne(e.params.pagination.bulletClass)))) {
      ...
      e.pagination && B.matches(ne(e.params.pagination.bulletClass)) && B.click();
    }
  }
  function $() {
    ...
    I && (e.isBeginning ? (g(I), f(I)) : (m(I), d(I))), L && (e.isEnd ? (g(L), f(L)) : (m(L), d(L)));
  }
  function z() {
  ...
  function C() {
    ...
    z() && e.pagination.bullets.forEach((I) => {
      e.params.pagination.clickable && (d(I), e.params.pagination.renderBullet || (w(I, "button"), u(I, L.paginationBulletMessage.replace(/\{\{index\}\}/, Xe(I) + 1)))), I.matches(ne(e.params.pagination.bulletActiveClass)) ? I.setAttribute("aria-current", "true") : I.removeAttribute("aria-current");
    });
  }
  const S = (L, I, B) => {
    d(L), L.tagName !== "BUTTON" && (w(L, "button"), L.addEventListener("keydown", y)), u(L, B), c(L, I);
  }, E = (L) => {
    o && o !== L.target && !o.contains(L.target) && (n = !0), e.a11y.clicked = !0;
  }, P = () => {
    ...
    const I = L.target.closest(`.${e.params.slideClass}, swiper-slide`);
    ...
    B || N || L.sourceCapabilities && L.sourceCapabilities.firesTouchEvents || (e.isHorizontal() ? e.el.scrollLeft = 0 : e.el.scrollTop = 0, requestAnimationFrame(() => {
      n || (e.params.loop ? e.slideToLoop(parseInt(I.getAttribute("data-swiper-slide-index")), 0) : e.slideTo(e.slides.indexOf(I), 0), n = !1);
    }));
  }, M = () => {
    const L = e.params.a11y;
    L.itemRoleDescriptionMessage && h(e.slides, L.itemRoleDescriptionMessage), L.slideRole && w(e.slides, L.slideRole);
    const I = e.slides.length;
    L.slideLabelMessage && e.slides.forEach((B, N) => {
      const G = e.params.loop ? parseInt(B.getAttribute("data-swiper-slide-index"), 10) : N, Y = L.slideLabelMessage.replace(/\{\{index\}\}/, G + 1).replace(/\{\{slidesLength\}\}/, I);
      u(B, Y);
    });
  }, k = () => {
    const L = e.params.a11y;
    e.el.append(r);
    const I = e.el;
    L.containerRoleDescriptionMessage && h(I, L.containerRoleDescriptionMessage), L.containerMessage && u(I, L.containerMessage), L.containerRole && w(I, L.containerRole);
    const B = e.wrapperEl, N = L.id || B.getAttribute("id") || `swiper-wrapper-${p(16)}`, G = e.params.autoplay && e.params.autoplay.enabled ? "off" : "polite";
    b(B, N), v(B, G), M();
    let {
      nextEl: Y,
      prevEl: K
    } = e.navigation ? e.navigation : {};
    Y = q(Y), K = q(K), Y && Y.forEach((O) => S(O, N, L.nextSlideMessage)), K && K.forEach((O) => S(O, N, L.prevSlideMessage)), A() && q(e.pagination.el).forEach((_) => {
      _.addEventListener("keydown", y);
    }), X().addEventListener("visibilitychange", T), e.el.addEventListener("focus", x, !0), e.el.addEventListener("focus", x, !0), e.el.addEventListener("pointerdown", E, !0), e.el.addEventListener("pointerup", P, !0);
  };
  function R() {
    r && r.remove();
    let {
    ...
    L = q(L), I = q(I), L && L.forEach((N) => N.removeEventListener("keydown", y)), I && I.forEach((N) => N.removeEventListener("keydown", y)), A() && q(e.pagination.el).forEach((G) => {
      G.removeEventListener("keydown", y);
    }), X().removeEventListener("visibilitychange", T), e.el && typeof e.el != "string" && (e.el.removeEventListener("focus", x, !0), e.el.removeEventListener("pointerdown", E, !0), e.el.removeEventListener("pointerup", P, !0));
  }
  i("beforeInit", () => {
...
function Wn(s) {
  ...
  function m(I) {
    !e || e.destroyed || !e.wrapperEl || I.target === e.wrapperEl && (e.wrapperEl.removeEventListener("transitionend", m), !(g || I.detail && I.detail.bySwiperTouchMove) && E());
  }
  const y = () => {
    ...
    f = (/* @__PURE__ */ new Date()).getTime(), e.autoplay.running = !0, z(), r("autoplayStart");
  }, C = () => {
    ...
    const N = () => {
      r("autoplayPause"), e.params.autoplay.waitForTransition ? e.wrapperEl.addEventListener("transitionend", m) : E();
    };
    ...
    e.isEnd && d < 0 && !e.params.loop || e.destroyed || !e.autoplay.running || (f = (/* @__PURE__ */ new Date()).getTime(), v ? (v = !1, z(d)) : z(), e.autoplay.paused = !1, r("autoplayResume"));
  }, P = () => {
    if (e.destroyed || !e.autoplay.running) return;
    const I = X();
    I.visibilityState === "hidden" && (v = !0, S(!0)), I.visibilityState === "visible" && E();
  }, T = (I) => {
    I.pointerType === "mouse" && (v = !0, g = !0, !(e.animating || e.autoplay.paused) && S(!0));
  }, x = (I) => {
    I.pointerType === "mouse" && (g = !1, e.autoplay.paused && E());
  }, M = () => {
    e.params.autoplay.pauseOnMouseEnter && (e.el.addEventListener("pointerenter", T), e.el.addEventListener("pointerleave", x));
  }, k = () => {
    e.el && typeof e.el != "string" && (e.el.removeEventListener("pointerenter", T), e.el.removeEventListener("pointerleave", x));
  }, R = () => {
  ...
  function l(a) {
    ...
    if (d.freeMode.momentum) {
      if (c.velocities.length > 1) {
        const C = c.velocities.pop(), S = c.velocities.pop(), E = C.position - S.position, P = C.time - S.time;
        e.velocity = E / P, e.velocity /= 2, Math.abs(e.velocity) < d.freeMode.minimumVelocity && (e.velocity = 0), (P > 150 || te() - C.time > 300) && (e.velocity = 0);
      } else
        e.velocity = 0;
      ...
      let A;
      if (m < e.maxTranslate())
        d.freeMode.momentumBounce ? (m + e.maxTranslate() < -z && (m = e.maxTranslate() - z), $ = e.maxTranslate(), y = !0, c.allowMomentumBounce = !0) : m = e.maxTranslate(), d.loop && d.centeredSlides && (A = !0);
      else if (m > e.minTranslate())
        d.freeMode.momentumBounce ? (m - e.minTranslate() > z && (m = e.minTranslate() + z), $ = e.minTranslate(), y = !0, c.allowMomentumBounce = !0) : m = e.minTranslate(), d.loop && d.centeredSlides && (A = !0);
      ...
      d.freeMode.momentumBounce && y ? (e.updateProgress($), e.setTransition(v), e.setTranslate(m), e.transitionStart(!0, e.swipeDirection), e.animating = !0, Fe(f, () => {
        !e || e.destroyed || !c.allowMomentumBounce || (i("momentumBounce"), e.setTransition(d.speed), setTimeout(() => {
          e.setTranslate($), Fe(f, () => {
            !e || e.destroyed || e.transitionEnd();
          });
        }, 0));
      })) : e.velocity ? (i("_freeModeNoMomentumRelease"), e.updateProgress(m), e.setTransition(v), e.setTranslate(m), e.transitionStart(!0, e.swipeDirection), e.animating || (e.animating = !0, Fe(f, () => {
        !e || e.destroyed || e.transitionEnd();
...
function Jn(s) {
  ...
  const a = () => {
    ...
    const {
      ...
      rows: y,
      fill: $
    } = e.params.grid, z = e.virtual && e.params.virtual.enabled ? e.virtual.slides.length : v.length;
    let A, C, S;
    if ($ === "row" && g > 1) {
      const E = Math.floor(u / (g * y)), P = u - y * g * E, T = E === 0 ? g : Math.min(Math.ceil((z - E * y * g) / y), g);
      S = Math.floor(P / T), C = P - S * T + E * g, A = C + S * r / y, b.style.order = A;
    ...
    if (e.virtualSize = (u + m) * r, e.virtualSize = Math.ceil(e.virtualSize / y) - m, e.params.cssMode || (e.wrapperEl.style[e.getDirectionLabel("width")] = `${e.virtualSize + m}px`), v) {
      ...
      for (let z = 0; z < b.length; z += 1) {
        let A = b[z];
        g && (A = Math.floor(A)), b[z] < e.virtualSize + b[0] && $.push(A);
      }
...
function ra(s) {
  ...
  Object.assign(e, {
    appendSlide: Zn.bind(e),
    prependSlide: ea.bind(e),
    addSlide: ta.bind(e),
    removeSlide: ia.bind(e),
    removeAllSlides: sa.bind(e)
  });
}
function Ie(s) {
  const {
  ...
  t({
    ...
    setTranslate: () => {
      ...
      for (let a = 0; a < o.length; a += 1) {
        ...
        const h = e.params.fadeEffect.crossFade ? Math.max(1 - Math.abs(p.progress), 0) : 1 + Math.min(Math.max(p.progress, -1), 0), c = We(l, p);
        c.style.opacity = h, c.style.transform = `translate3d(${f}px, ${w}px, 0px)`;
      }
    },
    setTransition: (o) => {
      const l = e.slides.map((a) => xe(a));
      l.forEach((a) => {
  ...
  Ie({
    ...
    setTranslate: () => {
      const {
        ...
        size: c,
        browser: u
      } = e, b = lt(e), v = e.params.cubeEffect, g = e.isHorizontal(), m = e.virtual && e.params.virtual.enabled;
      let y = 0, $;
      ...
      for (let A = 0; A < d.length; A += 1) {
        ...
        let E = S * 90, P = Math.floor(E / 360);
        h && (E = -E, P = Math.floor(-E / 360));
        const T = Math.max(Math.min(C.progress, 1), -1);
        let x = 0, M = 0, k = 0;
        S % 4 === 0 ? (x = -P * 4 * c, k = 0) : (S - 1) % 4 === 0 ? (x = 0, k = -P * 4 * c) : (S - 2) % 4 === 0 ? (x = c + P * 4 * c, k = c) : (S - 3) % 4 === 0 && (x = -c, k = 3 * c + c * 4 * P), h && (x = -x), g || (M = x, x = 0);
        const R = `rotateX(${b(g ? 0 : -E)}deg) rotateY(${b(g ? E : 0)}deg) translate3d(${x}px, ${M}px, ${k}px)`;
      ...
      if (p.style.transformOrigin = `50% 50% -${c / 2}px`, p.style["-webkit-transform-origin"] = `50% 50% -${c / 2}px`, v.shadow)
        if (g)
          ...
          const A = Math.abs(y) - Math.floor(Math.abs(y) / 90) * 90, C = 1.5 - (Math.sin(A * 2 * Math.PI / 360) / 2 + Math.cos(A * 2 * Math.PI / 360) / 2), S = v.shadowScale, E = v.shadowScale / C, P = v.shadowOffset;
          $.style.transform = `scale3d(${S}, 1, ${E}) translate3d(0px, ${w / 2 + P}px, ${-w / 2 / E}px) rotateX(-89.99deg)`;
        }
      const z = (u.isSafari || u.isWebView) && u.needPerspectiveFix ? -c / 2 : 0;
      p.style.transform = `translate3d(0px,0,${z}px) rotateX(${b(e.isHorizontal() ? 0 : y)}deg) rotateY(${b(e.isHorizontal() ? -y : 0)}deg)`, p.style.setProperty("--swiper-cube-translate-z", `${z}px`);
    },
    setTransition: (a) => {
      const {
        el: p,
...
function ze(s, e, t) {
  const i = `swiper-slide-shadow${t ? `-${t}` : ""}${s ? ` swiper-slide-shadow-${s}` : ""}`, r = xe(e);
...
function oa(s) {
  ...
  const r = (a, p) => {
    ...
    d || (d = ze("flip", a, e.isHorizontal() ? "left" : "top")), f || (f = ze("flip", a, e.isHorizontal() ? "right" : "bottom")), d && (d.style.opacity = Math.max(-p, 0)), f && (f.style.opacity = Math.max(p, 0));
  };
  Ie({
    effect: "flip",
    swiper: e,
    ...
    setTranslate: () => {
      const {
        slides: a,
        rtlTranslate: p
      } = e, d = e.params.flipEffect, f = lt(e);
      for (let w = 0; w < a.length; w += 1) {
        ...
        const $ = `translate3d(${m}px, ${y}px, 0px) rotateX(${f(g)}deg) rotateY(${f(v)}deg)`, z = We(d, h);
        z.style.transform = $;
      }
    },
    setTransition: (a) => {
      const p = e.slides.map((d) => xe(d));
      p.forEach((d) => {
  ...
  t({
    ...
    setTranslate: () => {
      const {
        ...
        slides: a,
        slidesSizesGrid: p
      } = e, d = e.params.coverflowEffect, f = e.isHorizontal(), w = e.translate, h = f ? -w + o / 2 : -w + l / 2, c = f ? d.rotate : -d.rotate, u = d.depth, b = lt(e);
      for (let v = 0, g = a.length; v < g; v += 1) {
        const m = a[v], y = p[v], $ = m.swiperSlideOffset, z = (h - $ - y / 2) / y, A = typeof d.modifier == "function" ? d.modifier(z) : z * d.modifier;
        let C = f ? c * A : 0, S = f ? 0 : c * A, E = -u * Math.abs(A), P = d.stretch;
        typeof P == "string" && P.indexOf("%") !== -1 && (P = parseFloat(d.stretch) / 100 * y);
        let T = f ? 0 : P * A, x = f ? P * A : 0, M = 1 - (1 - d.scale) * Math.abs(A);
        Math.abs(x) < 1e-3 && (x = 0), Math.abs(T) < 1e-3 && (T = 0), Math.abs(E) < 1e-3 && (E = 0), Math.abs(C) < 1e-3 && (C = 0), Math.abs(S) < 1e-3 && (S = 0), Math.abs(M) < 1e-3 && (M = 0);
        const k = `translate3d(${x}px,${T}px,${E}px)  rotateX(${b(S)}deg) rotateY(${b(C)}deg) scale(${M})`, R = We(d, m);
        if (R.style.transform = k, m.style.zIndex = -Math.abs(Math.round(A)) + 1, d.slideShadows) {
          let L = f ? m.querySelector(".swiper-slide-shadow-left") : m.querySelector(".swiper-slide-shadow-top"), I = f ? m.querySelector(".swiper-slide-shadow-right") : m.querySelector(".swiper-slide-shadow-bottom");
          L || (L = ze("coverflow", m, f ? "left" : "top")), I || (I = ze("coverflow", m, f ? "right" : "bottom")), L && (L.style.opacity = A > 0 ? A : 0), I && (I.style.opacity = -A > 0 ? -A : 0);
        }
      }
    },
    setTransition: (o) => {
      e.slides.map((a) => xe(a)).forEach((a) => {
...
function da(s) {
  ...
  Ie({
    ...
    setTranslate: () => {
      ...
      } = d, w = e.params.centeredSlides, h = lt(e);
      if (w) {
      ...
      for (let c = 0; c < l.length; c += 1) {
        ...
        v < 0 ? (A = d.next, z = !0) : v > 0 && (A = d.prev, z = !0), y.forEach((M, k) => {
          y[k] = `calc(${M}px + (${r(A.translate[k])} * ${Math.abs(v * f)}))`;
        }), $.forEach((M, k) => {
          let R = A.rotate[k] * Math.abs(v * f);
          $[k] = R;
        }), u.style.zIndex = -Math.abs(Math.round(b)) + l.length;
        const C = y.join(", "), S = `rotateX(${h($[0])}deg) rotateY(${h($[1])}deg) rotateZ(${h($[2])}deg)`, E = g < 0 ? `scale(${1 + (1 - A.scale) * g * f})` : `scale(${1 - (1 - A.scale) * g * f})`, P = g < 0 ? 1 + (1 - A.opacity) * g * f : 1 - (1 - A.opacity) * g * f, T = `translate3d(${C}) ${S} ${E}`;
        if (z && A.shadow || !z) {
          let M = u.querySelector(".swiper-slide-shadow");
          if (!M && A.shadow && (M = ze("creative", u)), M) {
            const k = d.shadowPerProgress ? v * (1 / d.limitProgress) : v;
            M.style.opacity = Math.min(Math.max(Math.abs(k), 0), 1);
          }
        }
        const x = We(d, u);
        x.style.transform = T, x.style.opacity = P, A.origin && (x.style.transformOrigin = A.origin);
      }
    },
    setTransition: (l) => {
      const a = e.slides.map((p) => xe(p));
      a.forEach((p) => {
  ...
  t({
    ...
    setTranslate: () => {
      ...
      for (let h = 0; h < o.length; h += 1) {
        ...
        let $ = 1, z = -p.perSlideRotate * b, A = p.perSlideOffset - Math.abs(b) * 0.75;
        const C = e.virtual && e.params.virtual.enabled ? e.virtual.from + h : h, S = (C === l || C === l - 1) && b > 0 && b < 1 && (f || e.params.cssMode) && w < d, E = (C === l || C === l + 1) && b < 0 && b > -1 && (f || e.params.cssMode) && w > d;
        if (S || E) {
          const M = (1 - Math.abs((Math.abs(b) - 0.5) / 0.5)) ** 0.5;
          z += -28 * b * M, $ += -0.5 * M, A += 96 * M, m = `${-25 * M * Math.abs(b)}%`;
        }
      ...
      `;
        if (p.slideShadows) {
          ...
          M || (M = ze("cards", c)), M && (M.style.opacity = Math.min(Math.max((Math.abs(b) - 0.5) / 0.5, 0), 1));
        }
...
const ua = [Bn, Rn, Nn, Hn, qn, Gn, Fn, Vn, Yn, jn, Xn, Un, Wn, Kn, Qn, Jn, ra, na, aa, oa, la, da, ca];
Q.use(ua);
const ct = [
  "eventsPrefix",
  "injectStyles",
...
function ti(s, e) {
  const t = ["__proto__", "constructor", "prototype"];
  Object.keys(e).filter((i) => t.indexOf(i) < 0).forEach((i) => {
    typeof s[i] > "u" ? s[i] = e[i] : Le(e[i]) && Le(s[i]) && Object.keys(e[i]).length > 0 ? e[i].__swiper__ ? s[i] = e[i] : ti(s[i], e[i]) : s[i] = e[i];
  });
}
function pa(s) {
...
}, is = ["a11y", "autoplay", "controller", "cards-effect", "coverflow-effect", "creative-effect", "cube-effect", "fade-effect", "flip-effect", "free-mode", "grid", "hash-navigation", "history", "keyboard", "mousewheel", "navigation", "pagination", "parallax", "scrollbar", "thumbs", "virtual", "zoom"];
function ss(s, e, t) {
  const i = {}, r = {};
  ti(i, ei);
  const n = [...ct, "on"], o = n.map((a) => a.replace(/_/, ""));
  n.forEach((a) => {
  ...
  return typeof e == "string" && typeof t < "u" && l.push({
    ...
    const p = is.find((d) => a.name.startsWith(`${d}-`));
    if (p) {
      const d = it(p), f = it(a.name.split(`${p}-`)[1]);
      ...
      const f = ts(a.value);
      r[d] && is.includes(a.name) && !Le(f) ? (r[d].constructor !== Object && (r[d] = {}), r[d].enabled = !!f) : r[d] = f;
    }
  }), ti(i, r), i.navigation ? i.navigation = {
    prevEl: ".swiper-button-prev",
    nextEl: ".swiper-button-next",
...
class Cs extends Ts {
  ...
  static get prevButtonSvg() {
    return rs.replace("/></svg>", ' transform-origin="center" transform="rotate(180)"/></svg>');
  }
  cssStyles() {
    return [
      ga,
...
`);
  ...
  render() {
    ...
    this.slideSlots > 0 && (e = e.replace(/::slotted\(([a-z-0-9.]*)\)/g, "$1")), e.length && Ms(this.shadowRoot, e), this.cssLinks().forEach((i) => {
  ...
  initialize() {
    ...
    this.swiperParams = t, this.passedParams = i, delete this.swiperParams.init, this.render(), this.swiper = new Q(this.shadowRoot.querySelector(".swiper"), {
      ...t.virtual ? {} : {
        observer: !0
      },
      ...t,
  ...
  updateSwiperOnPropChange(e, t) {
    ...
    this.passedParams = r, this.swiperParams = i, !(this.swiper && this.swiper.params[e] === t) && ma({
      swiper: this.swiper,
  ...
  static get observedAttributes() {
    return ct.filter((t) => t.includes("_")).map((t) => t.replace(/[A-Z]/g, (i) => `-${i}`).replace("_", "").toLowerCase());
  }
}
ct.forEach((s) => {
  s !== "init" && (s = s.replace("_", ""), Object.defineProperty(Cs.prototype, s, {
    configurable: !0,
    get() {
...
class ba extends Ts {
  ...
  render() {
    ...
    if (Ms(this.shadowRoot, wa), this.shadowRoot.appendChild(document.createElement("slot")), e) {
      const t = document.createElement("div");
...
const ya = () => {
  typeof window > "u" || (window.customElements.get("swiper-container") || window.customElements.define("swiper-container", Cs), window.customElements.get("swiper-slide") || window.customElements.define("swiper-slide", ba));
};
typeof window < "u" && (window.SwiperElementRegisterParams = (s) => {
  ct.push(...s);
});
var Sa = Object.defineProperty, ut = (s, e, t, i) => {
...
const ci = class ci extends Ge {
  constructor() {
    super(), this.config = "{}", this.qrModalVisible = !1, this.currentQR = {
      title: "",
      url: "",
      description: "",
      dataUrl: ""
    }, this.configObject = JSON.parse(this.config);
  }
  attributeChangedCallback(e, t, i) {
    if (super.attributeChangedCallback(e, t, i), e === "config" && t !== i)
      try {
  ...
  async showQRCode(e) {
    ...
    const t = await vr.toDataURL(e.url, {
      width: 200,
      margin: 1,
      color: {
        dark: "#000000",
    ...
    this.currentQR = {
      ...this.currentQR,
      dataUrl: t
    }, this.qrModalVisible = !0, this.requestUpdate();
  }
  closeQRModal() {
  ...
  render() {
    ...
    return De`
      ...
      (i) => De`
                    <swiper-slide>
                      <img src="${i}" class="app-screenshot" alt="App Screenshot" />
                    </swiper-slide>
                  `
    )}
              </swiper-container>
        ...
        >
          ...
          >
            ...
            <div class="h-50 w-50 mx-auto mb-4 flex items-center justify-center rounded-lg bg-gray-50 p-2">
              ${this.currentQR.dataUrl ? De`<img src="${this.currentQR.dataUrl}" alt="下载二维码" class="h-full w-full" />` : De`<div class="flex items-center justify-center">
...
let be = ci;
ut([
  ps({ type: String, attribute: "config", reflect: !0 })
], be.prototype, "config");
ut([
  ai()
], be.prototype, "configObject");
ut([
  ai()
], be.prototype, "qrModalVisible");
ut([
  ai()
], be.prototype, "currentQR");
customElements.define("mobile-app-page", be);
export {
  be as MobileAppPage
};
